...
public class VideoRecorder (
    ...
    private fun buildFile(): File? {
        ...
        val path = Environment.getExternalStoragePublicDirectory(Environment.DIRECTORY_MOVIES)?.absolutePath +
                "/MuseuDoCangacoAR/${date}_video.mp4"
        val file = File(path)
        curPath = path
    ...
    private fun buildFileApi29(): FileDescriptor?{
        ...
        val contentValues = ContentValues().apply {
            ...
            put(MediaStore.MediaColumns.RELATIVE_PATH, "Movies/MuseuDoCangacoAR")
        }
    ...
    private fun startRecording() {
        try {
            ...
            Toast.makeText(activity, "Erro ao gravar o vídeo.", Toast.LENGTH_LONG).show()
        }
        setupMediaRecorder()
